...
"""autogenerated by genpy from action_exp/AddActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddActionResult(genpy.Message):
  ...
  _type = "action_exp/AddActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_exp/AddResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_exp.msg.AddResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_exp.msg.AddResult()
