...
"""autogenerated by genpy from action_exp/AddActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddActionFeedback(genpy.Message):
  ...
  _type = "action_exp/AddActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_exp/AddFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = action_exp.msg.AddFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_exp.msg.AddFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback,) = _get_struct_d().unpack(str[start:end])
      return self
