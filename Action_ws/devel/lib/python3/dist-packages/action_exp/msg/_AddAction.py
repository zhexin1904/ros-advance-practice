...
"""autogenerated by genpy from action_exp/AddAction.msg. Do not edit."""
import codecs
import sys
...
import action_exp.msg
import actionlib_msgs.msg
import genpy
import std_msgs.msg

class AddAction(genpy.Message):
  _md5sum = "c5a07d3e9dd14475dfefd900484ff0e8"
  _type = "action_exp/AddAction"
...
"""
  ...
  _slot_types = ['action_exp/AddActionGoal','action_exp/AddActionResult','action_exp/AddActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = action_exp.msg.AddActionGoal()
      if self.action_result is None:
        self.action_result = action_exp.msg.AddActionResult()
      if self.action_feedback is None:
        self.action_feedback = action_exp.msg.AddActionFeedback()
    else:
      self.action_goal = action_exp.msg.AddActionGoal()
      self.action_result = action_exp.msg.AddActionResult()
      self.action_feedback = action_exp.msg.AddActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_goal.goal.target, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.feedback,) = _get_struct_d().unpack(str[start:end])
      return self
